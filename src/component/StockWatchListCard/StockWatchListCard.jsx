  ...
  return (
    <div className="stock_watchList_card_main">
      <div className="stock_watchlist_card_main_arrangeWidth">
        ...
        >
          <div className="stock_watchList_card_main_head_title">
            <span id="stock_watchList_card_main_head_title_name">
              {(watchlistTitle.charAt(0).toUpperCase()+ watchlistTitle.substring(1,watchlistTitle.length))}'s Watchlist
            </span>
            <span id="stock_watchList_card_main_head_title_item">{watchListData[watchlistTitle].length} item</span>
          </div>
          <div className="stock_watchList_card_main_head_icon" id={isOpenWatchlist?"stock_watchList_card_main_head_icon_rotate":null}>
            <svg
        ...
        <div className="stock_watchList_card_main_all_items_list_main_box">
          {watchListData[watchlistTitle].map((data) => (
            ...
            <div
              ...
              id={
                isOpenWatchlist
                  ? "disable_stock_watchList_all_items_list"
                  : null
              }
            >
