                                            ...
                                            <div className='input_email_div'>
                                                <div className='input_email_div'>
                                                    <div className='ied_center'>
                                                        ...
                                                        <input id={inputActive ? 'inputActive' : 'inputDeactivate'} type={isLoginPasswordHide?"password":"text"} onFocus={() => { checkInputFocus() }} onBlur={handleBlur} onChange={(e) => { setUserPassword(e.target.value) }} />

                                                        <div className='ied_center_password_hide_and_view' onClick={()=>{setIsLoginPasswordHide(!isLoginPasswordHide)}}>
                                                            {
                                                                !isLoginPasswordHide?
                                                                <svg id='ied_center_password_hide_and_view_svg_see' xmlns="http://www.w3.org/2000/svg" width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" className="lucide lucide-eye"><path d="M2.062 12.348a1 1 0 0 1 0-.696 10.75 10.75 0 0 1 19.876 0 1 1 0 0 1 0 .696 10.75 10.75 0 0 1-19.876 0"/><circle cx="12" cy="12" r="3"/></svg>
                                                                :
                                                                <svg id='ied_center_password_hide_and_view_svg_notSee' xmlns="http://www.w3.org/2000/svg" width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" className="lucide lucide-eye-off"><path d="M10.733 5.076a10.744 10.744 0 0 1 11.205 6.575 1 1 0 0 1 0 .696 10.747 10.747 0 0 1-1.444 2.49"/><path d="M14.084 14.158a3 3 0 0 1-4.242-4.242"/><path d="M17.479 17.499a10.75 10.75 0 0 1-15.417-5.151 1 1 0 0 1 0-.696 10.75 10.75 0 0 1 4.446-5.143"/><path d="m2 2 20 20"/></svg>
                                                            }
                                                        </div>
